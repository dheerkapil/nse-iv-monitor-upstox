...
BULLISH_PUT_FALL_PCT = -1.5      # ATM Put IV must decrease by more than 3%
BULLISH_OTM_CALL_RISE_PCT = 2.5  # OTM Call average IV must increase by more than 5%
BULLISH_OTM_PUT_FALL_PCT = -1.5  # OTM Put average IV must decrease by more than 3%

# Bearish signals
BEARISH_PUT_RISE_PCT = 2.5       # ATM Put IV must increase by more than 5%
BEARISH_CALL_FALL_PCT = -1.5     # ATM Call IV must decrease by more than 3%
BEARISH_OTM_PUT_RISE_PCT = 2.5   # OTM Put average IV must increase by more than 5%
BEARISH_OTM_CALL_FALL_PCT = -1.5 # OTM Call average IV must decrease by more than 3%